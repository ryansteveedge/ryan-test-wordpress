...
function twenty_twenty_one_scripts() {
	...
	//Page Service_list
   if(is_page_template('service_list.php')) {
		wp_enqueue_script('custom-scroll-ryan', get_template_directory_uri() . '/assets/js/custom-scroll-ryan.js', array(), '', true);
   }//endif
...
function register_service_tax() {
	...
	$args = [
		...
		"show_in_nav_menus" => true,
		"query_var" => true,
		"rewrite" => [ 'slug' => 'service_type', 'with_front' => true, ],
...
function service_shortcode($atts){
    ...
    if($query->have_posts()) :
        ...
        $result .= '<div class="movie-title">' . get_the_title() . '</div>';
        $result .= '</div>';
